...
const TickerItem = ({ tech, index, techStackLength, isMounted }) => {
  return (
    ...
    >
      <GlowingCard
        color={tech.color}
        className="w-20 h-20 md:w-32 md:h-32 group"
        borderRadius="16px"
      >
        <div className="relative flex flex-col items-center justify-center w-full h-full p-4 z-20">
          <div
          ...
          <h3 className="text-[0.7rem] md:text-sm font-semibold text-gray-900 dark:text-white text-center leading-tight">
            {tech.name}
          </h3>
        </div>
      </GlowingCard>
