  ...
  return (
    ...
    >
      <div className="flex items-center">
        ...
        <motion.span
          className="text-xs md:text-sm font-roboto text-left flex-1 font-light leading-tight md:leading-normal wrap-break-word hyphens-auto transition-all duration-200"
          animate={{
